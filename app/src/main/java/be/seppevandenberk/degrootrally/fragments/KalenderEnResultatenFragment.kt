...
class KalenderEnResultatenFragment : Fragment(R.layout.fragment_kalender_en_resultaten) {
    ...
    override fun onCreateView(
        ...
        if (rallyItemsFileRepo != null && rallyItemsFileRepo.read().size == 0) {
            val standard = initializeArray()
            rallyItemsFileRepo.save(standard)
        }
    ...
    fun initializeArray():ArrayList<RallyItem>{
        var data = ArrayList<RallyItem>()
        ...
        data.add(rallyVanHaspengouw2017)
        ...
        data.add(bouclesChevrotines2017)
        ...
        data.add(criteriumJeanLouisDumont2017)
        ...
        data.add(rallyVanZuidLimburg2017)
        ...
        data.add(rallyVanHaspengouw2018)
        ...
        data.add(rallyVanZuidLimburg2018)
        ...
        data.add(rallyVanHaspengouw2020)
        ...
        data.add(rallyVanHaspengouw2022)
        ...
        data.add(rallyeSprintDeHaillot2022)
        ...
        data.add(rallyVanZuidLimburg2022)
        ...
        data.add(rallyVanHaspengouw2023)
